...
/**
 * This {@link Task#POST} task performs a minus operation on two data sets. 
 *
...
public class Minus implements OnTask
{
    /** The MINUS variable. Defines name of the source to (data set) to "minus" from the current data set. */
    public static final String MINUS_VAR = "MINUS";
        ...
        throws Exception
    {
        ...
        String sourceName = task.getVariable(MINUS_VAR).getValue();
        ...
        dataSet = CommonEtlUtils.minus(dataSet, source.getDataSet(), task
                .getVariable(EtlConfig.KEYS_VAR).getValue());
        ...
        throws Exception
    {
        ...
        EtlUtils.addVar(task.getVariables(), MINUS_VAR, "", false);
