...
/**
 * Default ETL driver for the odbc complaint databases which does not support callable statements.
 * 
...
public class GenericOdbcDriver extends SimpleDriver
{
    ...
    /** The url. */
    private static final String JDBC_URL = "jdbc:odbc:name";
